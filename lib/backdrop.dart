...
const double _kFlingVelocity = 4.0;
...
class _BackdropState extends State<Backdrop>
  ...
  bool dropDownClickedFlag = false;
  ...
  void didUpdateWidget(Backdrop old) {
    ...
    setState(() {
      dropDownClickedFlag = dropDownClickedFlag? false:true;
    });
  ...
  void _toggleBackdropPanelVisibility() {
    print('      _toggleBackdropPanelVisibility(); is called');
  ...
  Widget _buildStack(BuildContext context, BoxConstraints constraints) {
    ...
    Animation<RelativeRect> panelAnimation = RelativeRectTween(
      end: RelativeRect.fromLTRB(40.0, panelTop, 40.0, panelTop-panelSize.height),
